...
-----------------------------------------------------------------------
--  功能: 更新tagging中关于用户注册绑定活跃的指标
--  修改日期: 2020-11-02
-----------------------------------------------------------------------
--  源表:u_analysis_dw.siebel_member
--       u_analysis_ods.tb_member_3app
--  目标表: u_analysis_app.member_bundle 
--          u_analysis_app.member_channel_active
--          u_analysis_app.member_Register_channel  
