...
-----------------------------------------------------------------------
--  功能: 汇集tagging daily的指标 
--  修改日期: 2020-11-02
-----------------------------------------------------------------------
--  源表:
--  u_analysis_app.communication_detail_tag_daily;
--  u_analysis_app.member_profile_loyalty_daily;
--  u_analysis_app.member_profile_vchr_balance_daily;
--  u_analysis_app.member_purchase_behavior_RFM_daily;
--  u_analysis_app.member_purchase_behavior_trans_daily;

--  目标表: u_analysis_app.tagging_daily
